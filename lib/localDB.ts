...
function createTables(db: SQLiteDatabase) {
  db.execSync(`
    ...
    CREATE TABLE IF NOT EXISTS almacenes (id TEXT PRIMARY KEY, nombre TEXT, codigo TEXT, color_hex TEXT, patron TEXT, color_secundario TEXT, activo INTEGER, updated_at TEXT);
